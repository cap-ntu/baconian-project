...
GlobalConfig().set('DEFAULT_LOG_PATH', './log_path/DQNtest_mountaincar2')
GlobalConfig().set('DEFAULT_EXPERIMENT_END_POINT', dict(TOTAL_AGENT_TRAIN_SAMPLE_COUNT=100000,
                                                        TOTAL_AGENT_TEST_SAMPLE_COUNT=None,
                                                        TOTAL_AGENT_UPDATE_COUNT=None), )
# single_exp_runner(task_fn, del_if_log_path_existed=True)
# duplicate_exp_runner(5, task_fn, del_if_log_path_existed=True)
...
#                                                                 save_format='png', )
MultipleExpLogDataLoader(exp_root_dir_list='./log_path/DQNtest_mountaincar2', num=5) \
    .plot_res(sub_log_dir_name='demo_exp_agent/TEST',
              key='sum_reward', index='sample_counter',
              mode='line', average_over=90, file_name='average_over_90', save_format='png', )